...
export default class extends React.Component<{}, {}> {
  ...
  ct = (
    title: string,
    ghLink?: string,
    extra?: { label: string; link: string }
  ) => {
    return (
      <h3>
        {title} &nbsp;
    ...
    return (
      <div>
        ...
        <p>
          ...
          {nl(7)}, allowing you to discover problems, solve and submit without
          leaving VScode.
        </p>
        ...
        <p>
          ...
          {nl(9)} for transpiling Markdown into a custom stylized html file,
          allowing you to create very easily a single page with some
          information.
        </p>
        ...
        <p>
          Very simple Shell script to compile, input entry and run C++ contest
          solutions. saves up a lot of time.
        </p>
        ...
        <p>
          A very simple SPA
          {nl(10)}
          -ish solution to calculate how much you need to score in the final
          test, this is made specific to UNEB
          {nl(11)}
          (with is my university btw), this project was make when e knew nothing
          about web development but is actually very useful and people have
          using it for years, so i will not shutdown it.
        </p>
        ...
        <p>
          Another SPA-ish, this is one is very simple, you write a message,
          click the button to copy a shareable link, send it to some one, and
          this person will only see the message when she opens the link, kinda
          like a envelope, but digital. Please don't be mean.
        </p>
        ...
        {ct("Other Projects")}
        <p>
          I do have other projects, but they are either abandoned or private.
        </p>
